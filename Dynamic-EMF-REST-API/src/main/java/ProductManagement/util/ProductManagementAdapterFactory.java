...
public class ProductManagementAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ProductManagementSwitch modelSwitch =
		new ProductManagementSwitch() {
			public Object caseProductModel(ProductModel object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link ProductManagement.ProductModel <em>Product Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link ProductManagement.Product <em>Product</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
