 ...
 * @generated
 */
public class ArchitecturemodelingSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ArchitecturemodelingSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ArchitecturemodelingPackage.COMPONENT: {
			...
			case ArchitecturemodelingPackage.CONNECTOR: {
				Connector connector = (Connector)theEObject;
				T result = caseConnector(connector);
				if (result == null) result = caseArchitectureElement(connector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
