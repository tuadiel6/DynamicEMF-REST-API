...
| Operation | Description                                                                                                                                                                      | HTTP <br>Method | Endpoint                                                                                                                                                                                                              |
|-----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| READ      | Read all elements from models that conform <br>to the same metamodel                                                                                                             | GET             | .../{packageName}/{className}/all                                                                                                                                                                                     |
| READ      | Filter an element of a specific model, filtered <br>by a key attribute and its corresponding value.                                                                              | GET             | .../{packageName}/{className}/{containmentName}/search?<br>attributeName=<param1>&attributeValue=<param2>                                                                                                             |
| ADD       | Add an element to a specific model                                                                                                                                               | POST            | .../{PackageName}/{parentClass}/{childClass}/{xmiFileName}/newElement                                                                                                                                                 |
| ADD       | Add an element to a specific class by specifying <br>the class with which it should be associated.                                                                               | POST            | .../{packageName}/{className}/{xmiFileName}/addExisting?<br>parentContainmentName=<param1>&attributeNameToMatch=<param2>&<br>attributeValueToMatch=<param3>&childClassName=<param4>&<br>childContainmentName=<param5> |
| ADD       | In the scenario of a bidirectional relationship, <br>add an element in a specific model by setting <br>the field reference to to point to an instance <br>of another class type. | POST            | .../{packageName}/{parentClassName}/{childClassName}/{xmiFileName}<br>/newEopposite?fieldType=<param1>                                                                                                                |
| UPDATE    | Update the element based on the key attribute <br>and its corresponding value                                                                                                    | PUT             | .../{packageName}/{className}/{xmiFileName}/update?<br>attributeName=&lt;param1&gt;&amp;attributeValue=&lt;param2&gt;<br>&amp;updatedValue=&lt;param3&gt;                                                             |
| DELETE    | Delete the element based on the key attribute <br>and its corresponding value                                                                                                    | DELETE          | .../{packageName}/{className}/{xmiFileName}/deleteByAttribute?<br>attributeName=<param1>&attributeValue=<param2>                                                                                                      |
| DELETE    | Delete an entire class by indicating the spcific<br>class to be deleted                                                                                                          | DELETE          | .../{packageName}/{className}/{xmiFileName}/deleteClassByXMI                                                                                                                                                          |
